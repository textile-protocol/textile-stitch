...
// they sit under Tools and not on Corridors. Saved through the same settings
// endpoint the Spreads form uses, so the config is rewritten and the bot
      ...
      {loaded && (
        <div className="space-y-4 border-t border-line-soft pt-4">
          <p className="text-xs text-faint">
            Manual overrides. Connect fills these in; only change them if Textile gave you a
